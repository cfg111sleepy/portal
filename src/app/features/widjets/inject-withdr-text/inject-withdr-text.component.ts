...
@Component({
  selector: 'app-inject-withdr-text',
  templateUrl: './inject-withdr-text.component.html',
  styleUrls: ['./inject-withdr-text.component.scss']
})
export class InjectWithdrTextComponent implements OnInit, OnChanges {
  @Input() key = "";
