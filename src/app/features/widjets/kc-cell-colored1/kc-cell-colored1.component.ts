...
@Component({
  selector: '[app-kc-cell-colored1]',
  templateUrl: './kc-cell-colored1.component.svg',
  styleUrls: ['./kc-cell-colored1.component.scss']
})
export class KcCellColored1Component implements OnInit, OnChanges {
  //синий RGB 0 89 168
