...
@Component({
  selector: '[app-table-cell-last2]',
  templateUrl: './table-cell-last2.component.html',
  styleUrls: ['./table-cell-last2.component.scss']
})
export class TableCellLast2Component implements OnInit, OnChanges {
  @Input() key = "";
